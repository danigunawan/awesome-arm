    ...
    if (!PIN_getInputValue(pinId)) {
        ...
        switch (pinId) {
            case Board_BUTTON0:
                ...
                currValed =  PIN_getOutputValue(Board_LED0);
            ...
            case Board_BUTTON1:
                ...
                PIN_setOutputValue(ledPinHandle, Board_LED1, !currValed);
                PIN_setOutputValue(ledPinHandle, Board_LED0, !currValed);
